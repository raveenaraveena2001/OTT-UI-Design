...
import 'package:untitled/tvshows.dart';

import 'Carouselnaviprime.dart';
import 'movie.dart';

class prime1 extends StatefulWidget {
  const prime1({super.key});
  
  @override
  State<prime1> createState() => _prime1State();
}

class _prime1State extends State<prime1> {
